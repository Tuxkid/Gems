flyplot <-
  function(mn = 1:12, ri = 3, cj = 4, line = T, cutoff.mono = NULL, data = NULL, 
           ...
           n.strategy = "mn", xlabels = NULL, countAll = TRUE,
